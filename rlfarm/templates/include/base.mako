...
<head lang="en">
    <meta charset="UTF-8">
    <meta name="description" content="FarmFresh - Creative HTML Template">
    <meta name="author" content="CreateIT">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=no, maximum-scale=1, shrink-to-fit=no">


    <title>FarmFresh - Creative HTML Template</title>
    ...
    <ul class="ct-menuMobile-navbar list-unstyled ct-u-backgroundDarkGray">
        <li class="dropdown active">
            ...
            <ul class="dropdown-menu" role="menu">
                <li class="active"><a href="index.html"><i class="fa fa-fw fa-home"></i>Homepage - Slider</a></li>
        ...
        <nav class="navbar navbar-default navbar--type1 yamm">
            ...
            <div class="container ct-navbar-container">
                ...
                <ul class="nav navbar-nav navbar-left ct-navbar--fadeInLeft">
                    <li class="dropdown yamm-sm active">
...
<li><a href="our-distributors2.html">Our Distributors 2</a></li>
    ...
    <main>
        ...
        <!-- Modal -->
        <div class="modal fade ct-modal" id="modal1" tabindex="-1" role="dialog" data-bg-image="assets/images/content/image2a.png">
                        ...
                        <div class="ct-modalBody-content">
                            ...
                            <form class="validateIt" role="form" action="assets/form/send.php" method="POST">
                                <div class="input-group">
                                    ...
                                    <span class="input-group-btn">
                                        <button class="btn ct-modalFormButton" type="submit">subscribe</button>
                                    </span>
                                </div><!-- /input-group -->
                            </form>
                        </div>
        ...
        <div class="container">
            <section class="ct-u-marginTop50 ct-u-marginBottom30">

                <div class="row">
                    <div class="col-lg-8">

                    <section class="ct-js-slick is-loading ct-slick ct-slick-arrow--type3 ct-u-marginBottom30" data-autoplay="false" data-arrows="true" data-items="1" data-XSitems="1" data-SMitems="1" data-MDitems="1">
                    <div class="item">
                        <article class="ct-imageBox ct-u-paddingBoth0">
                            <figure class="ct-imageBox-wrapperOuter">
                                <div class="ct-imageBox-container">
                                    <img src="assets/images/content/image1.jpg" alt="">
                                </div>
                                <figcaption class="ct-imageBox-wrapperInner ct-imageBox-wrapperInner--type1">
                                    <div class="ct-imageBox-titleContainer">
                                        <header class="ct-imageBox-title">
                                            <h4 class="ct-u-marginBottom0"><span>welcome to</span></h4>
                    ...
                    <div class="item">
                        <article class="ct-imageBox ct-u-paddingBoth0">
                            <figure class="ct-imageBox-wrapperOuter">
                                <div class="ct-imageBox-container">
                                    <img src="assets/images/content/image4.jpg" alt="">
                                </div>
                                <figcaption class="ct-imageBox-wrapperInner ct-imageBox-wrapperInner--type1">
                                    <div class="ct-imageBox-titleContainer">
                                        <header class="ct-imageBox-title">
                                            <h4 class="ct-u-marginBottom0"><span>use us</span></h4>
                    ...
                    <div class="item">
                        <article class="ct-imageBox ct-u-paddingBoth0">
                            <figure class="ct-imageBox-wrapperOuter">
                                <div class="ct-imageBox-container">
                                    <img src="assets/images/content/image5.jpg" alt="">
                                </div>
                                <figcaption class="ct-imageBox-wrapperInner ct-imageBox-wrapperInner--type1">
                                    <div class="ct-imageBox-titleContainer">
                                        <header class="ct-imageBox-title">
                                            <h4 class="ct-u-marginBottom0"><span>see our</span></h4>
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-6 col-sm-6">
                                <article class="ct-imageBox">
                                    <a href="single-product.html" title="image">
                                        <figure class="ct-imageBox-wrapperOuter">
                                            <div class="ct-imageBox-container">
                                                <img src="assets/images/content/image2.jpg" alt="">
                                                <div class="ct-decoration ct-decoration--type1">
                                                    <div>
                                                        <div class="ct-decoration-textContainer">
                                                            <div class="ct-decoration-text">
                                                                <h4><span>Up To 25% OFF</span></h4>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <figcaption class="ct-imageBox-wrapperInner ct-imageBox-wrapperInner--type2">
                                                <div class="ct-imageBox-titleContainer">
                                                    <header class="ct-imageBox-title">
                                                        <h2><span>3 - 15 <sup>TH</sup>March</span></h2>
                                                    </header>
                                                </div>
                                            </figcaption>
                                        </figure>
                                ...
                                <article class="ct-imageBox">
                                    <a href="single-product.html" title="image">
                                        <figure class="ct-imageBox-wrapperOuter">
                                                <div class="ct-imageBox-container">
                                                    <img src="assets/images/content/image1.jpg" alt="">
                                                    <div class="ct-decoration ct-decoration--type2">
                                                        <div class="ct-imageBox-titleContainer">
                                                            <div class="ct-decoration-textContainer">
                                                                <div class="ct-decoration-text">
                                                                    <header>
                                                                        <h2 class="ct-u-marginBoth0"><span>The</span></h2>
                                                                        <h4 class="ct-u-marginBottom20"><span>perfect blend</span></h4>
                                                                    </header>
                                                                </div>
                                                            </div>
                                                        </div>
                                            ...
                                            <figcaption class="ct-imageBox-wrapperInner">
                    ...
                    <article class="ct-imageBox">
                        <figure class="ct-imageBox-wrapperOuter">
                            ...
                            <figcaption class="ct-imageBox-wrapperInner ct-imageBox-wrapperInner--type3">
                                <div class="ct-imageBox-titleContainer">
                                    <header class="ct-imageBox-title">
                                        <a href="single-product.html"><h6><span class="ct-u-colorBrown">Organic Box of Vegetables for a whole week</span></h6></a>
                                    </header>
                                </div>
                            </figcaption>
                        </figure>
                        ...
                        <figure class="ct-imageBox-wrapperOuter">
                            ...
                            <figcaption class="ct-imageBox-wrapperInner ct-imageBox-wrapperInner--type3">
                                <div class="ct-imageBox-titleContainer ct-imageBox-container-shadow">
                                    <header class="ct-imageBox-title">
                                        <a href="single-product.html"><h6><span class="ct-u-colorBrown">beautiful wooden box full of eggplants</span></h6></a>
                                    </header>
                                </div>
                            </figcaption>
                        </figure>
                    ...
                    <article class="ct-imageBox">
                        <figure class="ct-imageBox-wrapperOuter">
                            ...
                            <figcaption class="ct-imageBox-wrapperInner ct-imageBox-wrapperInner--type3">
                                <div class="ct-imageBox-titleContainer ct-imageBox-container-shadow">
                                    <header class="ct-imageBox-title">
                                        <a href="single-product.html"><h6><span class="ct-u-colorBrown">wooden box with several types of tomatoes</span></h6></a>
                                    </header>
                                </div>
                            </figcaption>
                        </figure>
        ...
        <div class="container">
            <section class="ct-js-slick is-loading ct-slick ct-slick-arrow--type1" data-animations="true" data-autoplay="false" data-arrows="true" data-items="1" data-XSitems="1" data-SMitems="2" data-MDitems="3">
                <div class="item">
                    <article class="ct-imageBox">
                        <figure class="ct-imageBox-wrapperOuter">
        ...
        <section class="ct-u-backgroundGray">
            <div class="container">
        ...
        <section class="ct-u-paddingBottom50">
            <div class="container">
                <section class="ct-js-slick is-loading ct-slick ct-slick-arrow--type2" data-height="60" data-animations="true" data-autoplay="false" data-arrows="true" data-items="1" data-XSitems="2" data-SMitems="3" data-MDitems="5">
                    <div class="item">
